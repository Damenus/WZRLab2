...
void RysujScene()
{
	GLfloat BlueSurface[] = { 0.1f, 0.0f, 0.4f, 0.5f};
	GLfloat DGreenSurface[] = { 0.3f, 0.9f, 0.25f, 0.7f};
	GLfloat RedSurface[] = { 0.9f, 0.3f, 0.0f, 0.8f};
	GLfloat GreenSurface[] = { 0.2f, 0.6f, 0.45f, 1.0f};
